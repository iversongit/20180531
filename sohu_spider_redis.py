...
class SpiderThread(Thread):
    ...
    def run(self):
        while True:
            ...
            # 如果key m_sohu_task被其他线程先一步拿走了，就等待直到拿到再执行
            ...
            if not redis_client.sismember("visited_urls",current_url):
                ...
                if html_page not in [None,'']:
                    ...
                    #     redis_client.rpush('m_sohu_task',link)
...
def main():
    ...
    while redis_client.llen('m_sohu_task') != 0 or is_anySpider_alive(spider_threads):
    # while redis_client.exists('m_sohu_task') or is_anySpider_alive(spider_threads):
        pass
